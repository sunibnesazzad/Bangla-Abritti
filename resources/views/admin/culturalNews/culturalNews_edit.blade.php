            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form form action="/admin/culturalNews/update/{{ $culturalNew->CULTURAL_NEWS_ID }}" method="post" enctype="multipart/form-data">
                            <div class="header">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="সাংস্কৃতিক খবর" value="{{ $culturalNew->NEWS_TITLE }}" required="" name="news_name">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{ $culturalNew->EVENT_DATE }}" name="news_date" required="">
...
{{ $errors->first('event_date') }}
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"  name="news_text" required="">{{ $culturalNew->NEWS_DESC }}</textarea>
                                        </div>
                                    </div>
                                </div>
