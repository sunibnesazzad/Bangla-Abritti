            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form action="/admin/learning/update/{{ $learningList->LEARNING_ID }}" method="post">
                            <div class="header">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="এসো শিখি" value="{{ $learningList->LEARNING_TITLE }}" required="" name="learning_title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label>এসো শিখি অবস্থা </label>
                                            <select  class="form-control" name="learning_category" value="{{ $learningList->LEARNING_CATEGORY_ID }}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" name="learning_detail" style="min-height: 300px" required>{{ $learningList->LEARNING_DESC }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{ $learningList->PUBLISH_START_DATE }}" name="learning_date" required>
